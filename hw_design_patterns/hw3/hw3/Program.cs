...
namespace DesignPatterns.Homework
{
    ...
    // Implementation of CurrentConditionsDisplay class that implements IWeatherObserver
    ...
    // Implementation of StatisticsDisplay class that implements IWeatherObserver
    public class StatisticsDisplay : IWeatherObserver
    {
        ...
        public void Display()
        {
            ...
            Console.WriteLine($"Temperature Stats: Min {_minTemperature}°C, Max {_maxTemperature}°C, Avg {avgTemperature:F1}°C");
        }
    }

    // Implementation of ForecastDisplay class that implements IWeatherObserver
